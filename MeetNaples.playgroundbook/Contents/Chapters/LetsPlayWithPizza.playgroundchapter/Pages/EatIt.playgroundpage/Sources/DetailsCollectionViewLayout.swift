...
@objc(DetailsCollectionViewLayoutAttributes)
public class DetailsCollectionViewLayoutAttributes: UICollectionViewLayoutAttributes {
    ...
    override public func copy(with zone: NSZone? = nil) -> Any {
        let copiedAttributes: DetailsCollectionViewLayoutAttributes = super.copy(with: zone) as! DetailsCollectionViewLayoutAttributes
...
@objc(DetailsCollectionViewLayout)
public class DetailsCollectionViewLayout: UICollectionViewLayout {
    ...
    public var attributesList = [DetailsCollectionViewLayoutAttributes]()
    ...
    override public class var layoutAttributesClass: AnyClass {
        return DetailsCollectionViewLayoutAttributes.self
    }
    ...
    override public func prepare() {
        ...
        attributesList = (0..<collectionView!.numberOfItems(inSection: 0)).map({ (i) -> DetailsCollectionViewLayoutAttributes in
            ...
            let attributes = DetailsCollectionViewLayoutAttributes(forCellWith: IndexPath(item: i, section: 0))
